...
namespace Myrtille.Web
{
    public partial class Default : Page
    {
        ...
        {
            // Get Referrer
            //var req = Request.UrlReferrer.ToString();
        ...
        private bool ConnectRemoteServer()
        {
            ...
            var loginPassword = string.IsNullOrEmpty(passwordHash.Value) ? "" : CryptoHelper.RDP_Decrypt(passwordHash.Value);
